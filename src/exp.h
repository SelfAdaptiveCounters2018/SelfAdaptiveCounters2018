...
void CAIDA_experiment(int number, double &ret_error, int n, int m, long double &sigma, int sketch, double &ret_aae, long double &aae_sig) { //n is the memory size(in KB) and m is the number of arrays used in the sketch
	cout << sketch << endl;
	class_sketches* s[20];
	if (sketch == 0) {
...
void webpage_experiment(int number, double &ret_error, int n, int m, long double &sigma, int sketch, double &ret_aae, long double &aae_sig) { //n is the memory size(in KB) and m is the number of arrays used in the sketch
	cout << sketch << endl;
	class_sketches* s[20];
	if (sketch == 0) {
